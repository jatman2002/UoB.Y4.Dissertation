...
def run(restaurant_name):
    ...
    train = pd.read_csv(f'{os.getcwd()}/src/SQL-DATA/MLP-State-Soft-Label/Restaurant-{restaurant_name}-train.csv')
    ...
    test_predictor(f'Restaurant-{restaurant_name}/MLP4', val_data, tables, model, find_table, features)
    print()
    print('DONE!')