...
CUDA_VISIBLE_DEVICES=0 python3 src/train.py -r 2 -a MLP
CUDA_VISIBLE_DEVICES=0 python3 src/train.py -r 3 -a MLP
CUDA_VISIBLE_DEVICES=0 python3 src/train.py -r 4 -a MLP
CUDA_VISIBLE_DEVICES=0 python3 src/train.py -r 5 -a MLP
